...
class IntersectionToolsTest {
    ...
    fun intersectShouldDetectWhenItIntersect() {
        ...
        assertThat(IntersectionTools.doIntersect(p1, p4, p1, p3), equalTo(true))
        assertThat(IntersectionTools.doIntersect(p4, p1, p1, p3), equalTo(true))
        assertThat(IntersectionTools.doIntersect(p1, p4, p3, p1), equalTo(true))
        assertThat(IntersectionTools.doIntersect(p4, p1, p3, p1), equalTo(true))
        ...
        TODO("Add remaining tests when no intersection")
    }
}