<<<<<<< HEAD:app/src/main/java/ch/epfl/sdp/ui/camera/VlcFragment.kt
...
class VlcActivity : AppCompatActivity() {
    ...
    fun showGimbal(v : View){
        Log.d("DEBUG", "showGimbal clicked !")
        Drone.gimbalStuff()
    }
}
>>>>>>> 91c313b... setPitchAndYawAngle use:app/src/main/java/ch/epfl/sdp/VlcActivity.kt
