...
class MapActivity : MapViewBaseActivity(), OnMapReadyCallback {
    ...
    private lateinit var startOrReturnHomeButton: FloatingActionButton
    ...
    private var droneFlyingStatusObserver = Observer<Boolean> { newStatus ->
        updateDroneFlyingStatus(newStatus)
    }
    ...
    private fun updateDroneFlyingStatus(isFlying: Boolean) {
        startOrReturnHomeButton.setIcon(if (isFlying) R.drawable.ic_return else R.drawable.ic_start)
    }
